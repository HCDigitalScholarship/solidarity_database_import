...
SECRET_KEY = 'i@b3*3#sehrj8odc47tczzfhluzq8$f7z^%r^o%5224z^+^o&u'
...
DATABASES = {
    'default': {
        ...
        'USER': 'yxu1',
        'PASSWORD': 'XYXDOUDOU',
        'NAME': 'solidarity_test',
        'HOST': 'geo.haverford.edu',
...
MAP_WIDGETS = {
    ...
    "GOOGLE_MAP_API_KEY": "AIzaSyCcgY4MwelgM_TGBsyELyHxkDQ30GNnWAM"
}
